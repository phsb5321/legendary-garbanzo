    ...
    while True:  # Loop infinito
        try:
            ...
            getDatetime = time.strftime(
                "%d/%m/%Y %H:%M:%S")  # Formata a hora atual
            ...
            if len(msg_split) > 1:  # Se a mensagem tiver mais de uma parte
                ...
                if destino == remetente.get():  # Se o destinatário for o remetente
                    ...
                    # Insere uma linha em branco na lista
...
# posiciona o botão de enviar a mensagem
b_enviar.grid(row=5, column=2, sticky="n")
# posiciona o botão de enviar o remetente
...
# posiciona o botão de limpar a conversa
